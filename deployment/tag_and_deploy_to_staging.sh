...
then
    ...
    rsync -L  backups/latest.dmp staging.gula.devsbranch.com:/home/gula/deployment/backups/
    rsync -r -v media/ staging.gula.devsbranch.com:/home/gula/deployment/media
	...
	ssh staging.gula.devsbranch.com "cd /home/gula/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
